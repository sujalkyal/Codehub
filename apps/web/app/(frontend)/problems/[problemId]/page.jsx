...
export default function ProblemSolvePage() {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((res) => {
        setProblem(res.data);
        // Set default code to boilerplate for selected language
  ...
  return (
    <div className="min-h-screen bg-[#0B192C] flex flex-col md:flex-row">
      ...
      <div className="md:w-1/2 w-full p-8 bg-[#1E3E62] text-white flex flex-col gap-4 border-r border-[#0B192C]">
        ...
        <div className="text-base whitespace-pre-line mb-2">
          {problem.description}
        </div>
        <div>
        ...
        {runResult && (
          <div className="mt-4 bg-[#1E3E62] p-4 rounded text-white">
            ...
            {runResult.error ? (
              ...
              <pre className="whitespace-pre-wrap text-sm text-gray-200">{JSON.stringify(runResult, null, 2)}</pre>
            )}
          </div>
        )}
        {/* Submit Result */}
        {submitResult && (
          <div className="mt-4 bg-[#1E3E62] p-4 rounded text-white">
            ...
            {submitResult.error ? (
              ...
              <pre className="whitespace-pre-wrap text-sm text-gray-200">{JSON.stringify(submitResult, null, 2)}</pre>
            )}
          </div>
        )}
      </div>
